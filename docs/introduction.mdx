---
title: Introduction
description: "Welcome to Allinix"
---

Allinix is an autonomous AI Agent platform that empowers users to create
...
Allinix achieves goals by chaining calls to large language models such as GPT-4 and is designed to understand
...
<CardGroup cols={2}>
  <Card title="How It Works" icon="chart-mixed" href="/essentials/usecases">
    Understand how Allinix achieves goals by chaining language models.
  </Card>
...
<CardGroup cols={2}>
  <Card
    title="Allinix Website"
    icon="browser"
    href="https://allinix.allinix.ai/"
  >
    Explore our official website.
  </Card>
  <Card title="Github" icon="github" href="https://github.com/allinix/Allinix">
...
The entire Allinix team is incredibly excited for the road to follow. We have a ton of exciting features planned for the future, and we hope you'll join us on this journey.
